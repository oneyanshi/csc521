...
def MultipleAssignment0(pt, scope):
    ...
    name = [func_by_name(pt[2][0], pt[2], scope)[1]]
    scope[name] = func_by_name([4][0], pt[4], scope[1])
...
def FunctionCall1(pt, scope):
    ...
    # func_info = [lookup_in_scope_stack(name, scope), scope][1]
    # print([lookup_in_scope_stack(name, scope), scope])
